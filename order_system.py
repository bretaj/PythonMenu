def place_order(menu):
    ...
    while loop: 
        ...
        answer = input("Would you like to keep ordering? (N)o to quit: ")
        ...
        if answer == "n":  
            ...
            for order_item in order:
                prices_list.append(order_item["Price"]*order_item["Quantity"])
